...
class Title_Genre(models.Model):
    ...
    title_id = models.ForeignKey(Title, on_delete=models.CASCADE, related_name="genres")
    genre_id = models.ForeignKey(Genre, on_delete=models.SET_NULL, null=True, related_name="titles")
